...
redwood_avx2_to_f16_8:
	...
	vcvtps2ph	xmm1, ymm0, 0		// let as_i16(xmm1): i16 = transmute(to_f16(input))
	mov		rax, 0x7FFF7FFF
...
redwood_avx2_to_f32_8:
	vmovups		xmm0, [rdx]		// input(xmm0): i16
	vpxor		xmm1, xmm1, xmm1
	mov		rax, 0x7FFF7FFF
	vmovd		xmm2, rax
	vpbroadcastw	xmm2, xmm2
	vpand		xmm3, xmm2, xmm0	// let non_sign_bits(xmm3) = input & 0x7FFF;
	vpcmpgtw	xmm5, xmm1, xmm0        // let sign(xmm5): i16 = if 0 > input { -1 } else { 0 };
	vpmullw		xmm6, xmm3, xmm5	// let result_if_negative(xmm6) = non_sign_bits * sign;
	vpandn		xmm7, xmm5, xmm0	// let result_if_nonnegative(xmm7) = input & (!sign);
	vpor		xmm8, xmm6, xmm7        // return (xmm8) result_if_negative | result_if_nonnegative
	vcvtph2ps	ymm9, xmm8
	vmovups		[rcx], ymm9
	ret
